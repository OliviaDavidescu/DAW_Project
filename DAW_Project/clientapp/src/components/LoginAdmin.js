...
const LoginFormAdmin = () => {
	...
	const Auth = (e) => {
		e.preventDefault();
		dispatch(LoginAdmin({ username, parola }));
	};
			...
			<Container component="main" maxWidth="xs">
				...
				<Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
					...
					<Box component="form" onSubmit={Auth} noValidate sx={{ mt: 1 }}>
						...
						<Button type="submit" fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} onClick={() => navigate("/signupadmin")}>Nu aveti cont? Inregistrati-va aici.</Button>
					</Box>
				</Box>
			</Container>
	  	</ThemeProvider>
